 ...
 *
 * 2/3/2013 v1.3 - Old code, new controller 
 * 2/7/2013 v3.0.0a - newer code, new controller
 * Last build test with Arduino v1.0.1
 * 
 * Arclight - arclight@23.org
 * Danozano - danozano@gmail.com
 * 
 * ######## Hack Factory updates ########
 * This code now works with the Arduino Mega!
...
#define david   0xFFFFFFFF                  // Name and badge number in HEX. We are not using checksums or site ID, just the whole
#define david2  0xFFFFFFFF
#define jude 0xFFFFFFFF
